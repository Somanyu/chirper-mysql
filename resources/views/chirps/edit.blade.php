    ...
    <div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8">
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4 my-5">
            ...
            <form action="{{ route('images.destroy', $image->id) }}" method="POST">
                @csrf
                @method('DELETE')
                <div class="relative inline-flex items-center text-sm font-medium text-center text-white rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-gray-600 dark:focus:ring-blue-800">
